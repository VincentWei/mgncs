...
#if defined _MGNCSCTRL_OLD_MLEDIT && defined _MGNCSCTRL_DIALOGBOX
...
static BOOL mymain_onCreate(mWidget* self, DWORD add_data)
{
	...
	for (i=IDC_BTN1; i<= IDC_BTN17; i++) {
		ncsAddEventListener((mObject*)ncsGetChildObj(self->hwnd,i),
				(mObject*)edit, (NCS_CB_ONPIECEEVENT)btn_notify, NCSN_BUTTON_PUSHED);
	}
...
#else	// _MGNCSCTRL_OLD_MLEDIT _MGNCSCTRL_DIALOGBOX

int main(int argc, const char* argv[])
{
	fprintf(stderr, "WARNING, your mgncs is not open the mledit support, use --enable-old-mledit --enable-dialogbox to rebuild your mgncs\n");
	return 0;
}

#endif	// _MGNCSCTRL_OLD_MLEDIT _MGNCSCTRL_DIALOGBOX
