...
static LRESULT mListView_wndProc(mListView* self, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch(message){
        case MSG_SETCURSOR:
            {
    ...
    return Class(mItemView).wndProc((mItemView*)self, message, wParam, lParam);
}
